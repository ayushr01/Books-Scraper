...
class BookParser:
    ...
    def __init__(self, parent):
        ...
        self.parent = parent # An item we used soup to get can be used by soup again
...
"""
    ...
    def price(self):
        ...
        expression = '£([0-9]+\.[0-9]+)'
        price = re.search(expression, item_price)
        float_price = float(price.group(1))
    ...
    def rating(self):
        ...
        rating_number = BookParser.RATINGS.get(classes[1])
